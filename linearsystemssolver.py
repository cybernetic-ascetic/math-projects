...
class Matrix:
  ...
  def reduce_pass(self, direction):
    ...
    for row_index, row in search_area:
      ...
      if not (is_array_zeros(row) or is_array_hot(pivot_column) or pivot == 0):
  ...
  def rows_triangulate(self):
    ...
    swap_path = find_swap_sort_path(self.rows, get_pivot_index)
...
eq2 = [1,0,0,5]
eq3 = [1,1,0,-1]
eqs = [eq1,eq2,eq3] # be sure to include every equation in this list
